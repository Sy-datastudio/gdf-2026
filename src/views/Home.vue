        ...
        <div class="space-y-8">
          ...
          <div class="flex gap-6 pt-4">
            ...
            >
              ...
              <span class="text-[10px] tracking-widest text-white/50">
                {{ item.label }}
              </span>
            </div>
          </div>
      ...
      <div class="max-w-7xl mx-auto space-y-16">
        ...
        <div class="text-center space-y-4">
          ...
          <h3 class="text-5xl font-black">
            Decarbonization is entering a
            <span class="text-primary">compliance-driven phase</span>
          </h3>
        </div>
    ...
    <section class="py-32 px-6">
      <div class="max-w-7xl mx-auto space-y-16">
        ...
        <div class="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <h3 class="text-5xl font-black">Curated Discussion</h3>
        </div>

        <div class="max-w-3xl mx-auto">
          <div v-if="mainPanel" class="p-10 bg-white/5 border border-white/10 rounded-xl text-center">

            <h4 class="text-2xl font-bold">{{ mainPanel.title }}</h4>
...
const contextCards = [
  {
    ...
    text: 'IMO targets, EU ETS inclusion, and FuelEU Maritime are creating enforceable, cost-linked obligations.',
  },
  {
    icon: DollarSign,
    title: 'Cost Exposure',
    text: 'Carbon pricing and fuel differentials are directly impacting voyage economics and fleet strategy.',
  },
  {
    icon: BarChart3,
    title: 'Measurement Becomes Control',
    text: 'MRV, CII, and real-time emissions tracking are turning data into an operational constraint.',
  },
]
...
const panels = [
  {
    ...
    subtitle:
      'Cost exposure, fuel strategy, and emissions intelligence as drivers of competitive positioning',
    points: [
